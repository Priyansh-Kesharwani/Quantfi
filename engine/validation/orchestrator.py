...
from engine.validation.objective import (
    compute_dsr,
    compute_gt_score,
    equity_curve_from_result,
)
from engine.validation.validator import CPCVConfig, CPCVSplit, generate_cpcv_splits
...
def _load_data(
    ...
    from engine.backtester.portfolio_simulator import prepare_multi_asset_data
...
def _config_to_sim_config(
    ...
    *,
    ...
    from engine.backtester.portfolio_simulator import ExitParams, SimConfig
...
def _config_to_alloc_config(
    ...
    *,
    ...
    from engine.backtester.portfolio_simulator import AllocationConfig
...
def run_backtest_on_split(
    ...
    *,
    ...
    if config.get("use_bot"):
        from engine.validation.bot_backtest import run_bot_backtest
        ...
        from engine.backtester.portfolio_simulator import AllocationEngine
        ...
        from engine.backtester.portfolio_simulator import PortfolioSimulator
...
def run_orchestrator(
    ...
    *,
    ...
    if grid_search and is_allocation:
        ...
        try:
            from engine.validation.mfbo import run_mfbo
