...
from engine.validation.metrics import information_coefficient, forward_returns
...
def _refactor_composite_score_from_df(df: pd.DataFrame) -> pd.Series:
    ...
    from engine.indicators.refactor_components import ofi_refactor, vwap_z_refactor, hurst_refactor
