...
from engine.validation.kfold import _purged_kfold_splits, purged_kfold, KFoldResult
from engine.validation.walkforward import _generate_folds, walkforward_cv, WalkForwardResult
from engine.simulations.hawkes_simulator import (
...
class TestAggregateOOS:
    ...
    def test_empty_folds(self):
        from engine.validation.phase3_runner import _aggregate_oos
...
class TestThresholdSweep:
    ...
    def test_higher_threshold_fewer_signals(self, synth_df):
        from engine.validation.phase3_runner import _threshold_sweep
...
class TestSubsampleStability:
    ...
    def test_determinism(self, synth_df):
        from engine.validation.phase3_runner import _subsample_stability
...
class TestComputeChecksum:
    ...
    def test_determinism(self, tmp_path):
        from engine.validation.phase3_runner import _compute_checksum
