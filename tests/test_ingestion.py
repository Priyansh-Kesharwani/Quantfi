...
def test_build_bars_1min_fixture_values():
    ...
    # First bar: 10:00:00–10:01:00 has open=100, high=100.5, low=99.8, close=100.2, volume=100+50+200+150=500
    first = bars.iloc[0]
    ...
    # VWAP = (100*100 + 100.5*50 + 99.8*200 + 100.2*150) / 500
    # = (10000 + 5025 + 19960 + 15030) / 500 = 50015/500 = 100.03
